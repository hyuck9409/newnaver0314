        ...
        <tr>
            <td>
                ...
                <form action="./insert" method="post" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered" style="width: 400px;">
                        <caption><h4><b>${num==0?"새글쓰기":"답글쓰기"}</b></h4></caption>
                        <tr>
                            <th width="100" class="table-warning">제목</th>
                            <td><input type="text" name="subject" required="required" value="${subject}" class="form-control"></td>
                        </tr>
                        <tr>
                            <th width="100" class="table-warning">사진</th>
                            <td><input type="file" name="upload" id="upload" class="form-control" onchange="previewFile();"></td>
                        </tr>
                        <tr>
                            <td colspan="2"><textarea name="content" required="required" style="width: 100%; height: 150px;" placeholder="내용을 입력하세요"></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
            ...
            <td>
                <!-- Image preview area -->
                <div>
                    <img id="image-preview" src="${uploadphoto}" alt="Image Preview" style="display: none; max-width: 300px;">      
                </div>  
            </td>
        </tr>
    </table>
