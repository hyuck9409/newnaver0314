...
<div class="table-container">
    <form action="mbtiaction.jsp" method="post" enctype="multipart/form-data">
        ...
        <caption align="top"><b>글쓰기</b></caption>
            ...
            <tr>
                <td colspan="2">
                    <input type="text" style="width: 100%;height:300px;" name="content" class="form-control" required="required">
                </td>
            </tr>
            <tr>
